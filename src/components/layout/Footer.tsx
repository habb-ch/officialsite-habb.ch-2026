        ...
        <div className="border-t border-habb-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.linkedin.com/company/habb-ch/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-habb-gray-400 hover:text-swiss-red transition-colors">
                <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-hidden>
              ...
              <a href="https://www.instagram.com/habb_ch/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-habb-gray-400 hover:text-swiss-red transition-colors">
                <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-hidden>
